...
<head>
    <%
        List<Region> regions=RegionRepo.getByCountry(UUID.fromString(request.getParameter("countryId")));
...
<div class="container mt-5">
    <div class="card">
        ...
        <div class="card-body">
            <form action=<%=isEditing?"/district/edit":"/district/add"%> method="POST">
                <div class="form-group">
                    ...
                    <label>
                        <input type="text" class="form-control" name="name" required value=<%=request.getParameter("name")%>  >
                    </label>
                </div>
